...
class Products extends Model
{
    ...
    /**
     * Stock Report uses same query - kept for backward compatibility
     */
    public function getStockReport($search = '', $filters = [], $limit = 100, $offset = 0, $sort = 'p.created_at', $order = 'desc')
    {
